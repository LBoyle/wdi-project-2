...
User
  ...
  .then(users => {
    return console.log(`${users.length} users created`);
  })
    ...
    // const options = {
    //   uri: 'https://app.ticketmaster.com/discovery/v2/events.json?apikey=sJdyvBFWmrZySkRDzJ2v0wNi2qtLb7pn&marketId=201&size=30',
    //   // uri: 'https://app.ticketmaster.com/discovery/v2/venues.json?apikey=sJdyvBFWmrZySkRDzJ2v0wNi2qtLb7pn'
    //   headers: {
